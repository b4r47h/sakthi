...
const EnhancedVehicleBatteryFinder = () => {
                ...
                battery_options: [
                    {
                        ...
                        brand_models: {
                            "Exide": {
                                ...
                                price: "₹9500-10500",
                                warranty: "72 months",
                                special_features: ["MPV grade", "Extra reserve capacity"]
                            },
                            "Amaron": {
                                model: "DIN65 Hi-Life",
                                price: "₹9000-10000",
                                warranty: "60 months",
                                special_features: ["Zero maintenance", "High starting power"]
                            }
                        }
                    }
                ]
                ...
                battery_options: [
                    {
                        ...
                        brand_models: {
                            "Exide": {
                                ...
                                price: "₹9500-10500",
                                warranty: "48 months",
                                special_features: ["Rural grade", "Heavy vibration resistance"]
                            },
                            "Amaron": {
                                model: "N70 Black",
                                price: "₹8800-9900",
                ...
                battery_options: [
                    {
                        ...
                        brand_models: {
                            "Exide": {
                                ...
                                price: "₹5600-6300",
                                warranty: "60 months",
                                special_features: ["High vibration resistant", "Export grade"]
                            },
                            "Amaron": {
                                model: "DIN44 Go",
                                price: "₹4900-5600",
                                warranty: "48 months",
                                special_features: ["Quick starting", "Temperature tolerant"]
                            }
                        }
                    }
                ]
                ...
                battery_options: [
                    {
                        ...
                        brand_models: {
                            "Exide": {
                                ...
                                price: "₹4000-4300",
                                warranty: "48 months",
                                special_features: ["OEM fitment", "Fast recovery"]
                            },
                            "Amaron": {
                                model: "38B20L Fresh",
                                price: "₹3600-4200",
                                warranty: "48 months",
                                special_features: ["Long life", "Quick charge"]
                            }
                        }
                    }
                ]
                ...
                battery_options: [
                    {
                        ...
                        capacity_ah: 100,
                        cca: "650-900A",
                        dimensions_mm: "410x175x233",
                        weight_kg: 26.0,
                        price_range_inr: "₹10800-13000",
                        warranty_months: 48,
                        brand_models: {
                            "Exide": {
                                model: "N100 FML0",
                                price: "₹12000-13000",
                                warranty: "48 months",
                                special_features: ["High cranking power", "Heavy duty"]
                            },
                            "Amaron": {
                                model: "N100 Tall Tubular",
                                price: "₹10800-12800",
                                warranty: "36 months",
                                special_features: ["Rugged design", "Export tested"]
                            }
                        }
                    }
                ]
                ...
                battery_options: [
                    {
                        ...
                        brand_models: {
                            "Exide": {
                                ...
                                price: "₹10100-11000",
                                warranty: "48 months",
                                special_features: ["Extra tough build", "Fast charging"]
                            },
                            "Amaron": {
                                model: "N70 Black",
                                price: "₹9300-10400",
                ...
                battery_options: [
                    {
                        ...
                        capacity_ah: 57,
                        cca: "360-470A",
                        dimensions_mm: "242x175x190",
                        weight_kg: 18.5,
                        price_range_inr: "₹9000-10200",
                        warranty_months: 42,
                        brand_models: {
                            "Exide": {
                                model: "N60 FML0",
                ...
                battery_options: [
                    {
                        ...
                        capacity_ah: 150,
                        cca: "1000-1100A",
                        dimensions_mm: "500x175x233",
                        weight_kg: 42.0,
                        price_range_inr: "₹14500-18500",
                        warranty_months: 48,
                        brand_models: {
                            "Exide": {
                                model: "N150 Super",
                                price: "₹17500-18500",
                                warranty: "48 months",
                                special_features: ["Extra heavy-duty", "Long cycle life"]
                            },
                            "Amaron": {
                                model: "N150 Tall Tubular",
                                price: "₹14500-17000",
                                warranty: "36 months",
                                special_features: ["Tubular plates", "Export quality"]
                            }
                        }
                    }
                ]
    ...
    interface MultiOptionBatteryCardProps {
        vehicle: string;
        vehicleData: {
    ...
    const MultiOptionBatteryCard = ({ vehicle, vehicleData }: MultiOptionBatteryCardProps) => (
        <div className="bg-black text-white rounded-lg shadow-lg p-6 sm:p-1 border-2 border-green-400">
    ...
    return (
        <div className="text-white">
            ...
            <div className="mt-8 mb-8">
                <h2 className="text-lg font-bold text-center pb-4 text-red-500 mb-3">Understanding Battery Codes & Standards</h2>
                <div className="grid md:grid-cols-4 gap-4 text-sm text-center text-gray-200">
                    <div>
            ...
            <span className="text-yellow-400 md:mx-56 text-xs">Disclaimer:The information provided here is for general guidance and may not be entirely accurate for all situations. Please contact us to get an exact match or personalized recommendation.
            </span>
        </div>
